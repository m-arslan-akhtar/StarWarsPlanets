...
public abstract class Hilt_PlanetListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlanetListFragment() {
    super();
  }

  Hilt_PlanetListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlanetListFragment_GeneratedInjector) this.generatedComponent()).injectPlanetListFragment(UnsafeCasts.<PlanetListFragment>unsafeCast(this));
    }
  }
